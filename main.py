...
# Загрузка звуков
piypau = [pygame.mixer.Sound(r'sound\piu.ogg'),
          pygame.mixer.Sound(r'sound\pay.ogg')]  # звук при выстреле

pygame.mixer.music.load(r"sound\main_music.mp3")  # фоновая музыка
pygame.mixer.music.set_volume(0.2)

# Загрузка фонового изображения
try:
    bg_url = r"background\bg_game.jpg"
...
class Player:
    ...
    def load_sprites(self):
        ...
        sprite_files = [fr"sprite\running_man({i}).png" for
                        i in range(1, 9)]
        self.sprites = []
...
enemy_sprite = pygame.image.load(r"sprite\pomidor.png").convert_alpha()
...
def run_game():
    ...
    while True:
        ...
        # Отображаем счет
        font = pygame.font.Font(r'fonts/ofont.ru_Arco.ttf', 36)
