...
# Шрифты
font_big = pygame.font.Font(r"fonts\ofont.ru_Arco.ttf", 74)
font_small = pygame.font.Font(r"fonts\ofont.ru_Arco.ttf", 36)
font_rules = pygame.font.Font(r"fonts\ofont.ru_Arco.ttf", 24)
font_button = pygame.font.Font(r"fonts\ofont.ru_Arco.ttf", 18)
...
def show_rules():
    # читаем файл
    try:
        with open(r"rules.txt", "r", encoding="utf-8") as file:
...
def show_main_menu():
    try:
        background_image = pygame.image.load(r"background\bg_menu.png")
